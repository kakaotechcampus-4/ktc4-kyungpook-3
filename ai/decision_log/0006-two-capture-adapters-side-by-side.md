...
멘토는 9/16 에 배치를 골랐다. 처음에는 고르지 않은 쪽을 지우기로 했지만, 2026-09-26 에 실시간 경로는
지우지 않고 보관하기로 바꿨다. 이후 회의 중 전사를 서비스에 다시 넣을 수 있고, 그때 실제 서버에서
끝까지 돌았던 이 코드가 출발점이 된다. 멘토도 #45 1차 리뷰(고민 7)에서 남겨도 된다고 했다.
